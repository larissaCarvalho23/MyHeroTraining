    ...
    $translateProvider.translations('pt-BR', {
      HEADER: {
        ...
        CADASTRO: {
          ...
          SENHA: 'Senha',
          ESENHA: 'Confirme a Senha',
          ESENHA1: 'Senha não atende os requisitos',
          ESENHA2:
            'Senha inválida, por favor digite uma senha com no mínimo 8 caracteres',
          PSENHA: 'Digite sua senha',
          ESENHA3: 'Senhas Divergentes',
          DICASENHA:
    ...
    $translateProvider.translations('en-US', {
      HEADER: {
        ...
        CADASTRO: {
          ...
          SENHA: 'Password',
          ESENHA: 'Confirm your password',
          ESENHA3: 'Divergent Passwords',
          ESENHA1: 'Password does not meet the requirements',
          ESENHA2:
